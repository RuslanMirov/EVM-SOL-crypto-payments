...
router.post('/', async (req, res) => {
  try {
    ...
    console.log(`[payment:new] user=${payment.user_id} id=${payment.id} address=${address} amount=${amount} ${sym} token=${token_mint} chain=solana expires=${new Date(payment.expires_at).toISOString()}`);
